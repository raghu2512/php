...
$total = new tax($product_name, $product_price, $is_imported, $is_other);
...
<body>
    ...
    <form action="/index.php" method="POST">
        ...
        <input type="text" name="is_other" id="is_other" placeholder="Type Yes or No">
        <input type="text" name="is_imported" id="is_imported" placeholder="Type Yes or No">
